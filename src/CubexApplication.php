...
use CubexIo\Content\ContentController;
...
class CubexApplication extends Application implements WithContext
{
  ...
  protected function _generateRoutes()
  {
    ...
    yield self::_route(
      self::DISPATCH_PATH,
      new FuncHandler(
        function (\Packaged\Context\Context $c): \Symfony\Component\HttpFoundation\Response {
  ...
  protected function _initialize()
  {
    ...
    $dispatch->addComponentAlias('\\CubexIo', 'CIO');
